...
class GuiImage : public GuiElement
{
	public:
		...
		void SetImage(struct XenosSurface * img);
		//!\overload
	...
	protected:
		...
		XenosSurface * image; //!< Poiner to image data. May be shared with GuiImageData data
